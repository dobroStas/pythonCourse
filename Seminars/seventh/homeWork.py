...
# def parapa(song) :          #считаем коллво гласнх в каждом элементе списка фраз
...
#         return len(slog) == slog.count(slog[0])     # ф-ия выполняется если длина списка равна колличесву слогов в slog[0]
